...
//    public String getAccountBalance(String userName) throws SQLException {
...
//
//        MyArrayList<UserModel> userResults = new MyArrayList<>();
//
//        if(rs.next()){
//            UserModel tempModel = new UserModel(rs.getInt("userID"), rs.getString("userName"), rs.getString("userPassword"));
//            userResults.add(tempModel);
//        } else {
//
//        }
//        return userName;
